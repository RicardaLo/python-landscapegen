...
# ¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤ #
	...
	#soil[, markpolyID:=as.numeric(markpolyID)]
...
# ¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤ #
	...
	#SnF[, c('BedriftPlusID', 'AfgKode'):=NULL]
	#SnF[, BedriftID:=gsub(pattern = ',', replacement = '', x = SnF$BedriftID, fixed = FALSE)]
	#SnF[, BedriftID:=as.numeric(BedriftID)]
    #write.csv(SnF, file = 'e:/Gis/FarmAndSoil2013.csv', row.names = FALSE)
    SnF = fread('e:/Gis/FarmAndSoil2013.csv')
...
# ¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤ #
	...
	temp[,c('AlmassCode', 'BedriftID') := NULL]
